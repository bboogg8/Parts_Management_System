...
public class AddTransactionServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement pStatement = connection.prepareStatement("insert into management.transaction(supplyId,buyId,partPrice,partNum,suggestion,customerStatus,supplierStatus) values(?,?,?,?,?,?,?)");
