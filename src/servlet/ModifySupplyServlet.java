...
@WebServlet(name = "ModifySupplyServlet",urlPatterns = {"/servlet/modifySupply"})
public class ModifySupplyServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //更新数据库信息
            PreparedStatement pStatement = connection.prepareStatement("update management.supply set partId=? ,partPrice = ? ,partNum = ? where id=?");
