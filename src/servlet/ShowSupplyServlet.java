...
public class ShowSupplyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            pStatement = connection.prepareStatement("select partId,partPrice,partNum,created,supplierId,id from management.supply"+partLimit+userLimit);
            ...
            while (rowSet.next()){
                ...
                pStatement = connection.prepareStatement("select name from management.supplier WHERE id = ?");
