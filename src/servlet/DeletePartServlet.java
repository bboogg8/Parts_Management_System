...
@WebServlet(name = "DeletePartServlet",urlPatterns = {"/servlet/deletePart"})
public class DeletePartServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //更新数据库信息
            PreparedStatement pStatement = connection.prepareStatement("delete from management.parts where id=?");
