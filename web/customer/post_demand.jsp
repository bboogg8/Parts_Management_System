                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="/servlet/addDemand">
                            <input required type="hidden" name="customerId" value="<%= ((Login)(request.getSession(true).getAttribute("login"))).getUserId() %>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">选择零件</label>
                                <div class="col-sm-10">
